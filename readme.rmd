...
If there are any issues, feel free to contact us (you may also need to install the r-versions of Keras and Tensorflow in Anaconda as well which has the versions 2.2.4.1 & 1.13.1, respectively.) and we
